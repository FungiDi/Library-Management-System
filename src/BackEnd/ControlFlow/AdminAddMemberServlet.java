...
@WebServlet(urlPatterns = "adminAddMember")
public class AdminAddMemberServlet extends CustomServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            RequestDispatcher rd = req.getRequestDispatcher("adminAddMember.jsp");
            rd.forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (session.getAttribute("name") != null) {
            if (memberInterface.add(member)){
                resp.sendRedirect("adminAddMember");
            }
            else {
                PrintWriter out = resp.getWriter();
                out.print("<html><body><p> An error occurred please try again <a href=\"adminAddMember\">Back</a> </p></body></html>");
            }
        }else {
            PrintWriter out = resp.getWriter();
