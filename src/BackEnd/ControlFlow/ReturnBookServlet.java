...
public class ReturnBookServlet extends CustomServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(b!=null&&m!=null){
            ...
            b.setStatus("Not issued");

            issueBookActivity.setReturnDate(String.valueOf(d));
            System.out.println("Okay");
            issueBookActivity.setIssueDate((get(req,"returnDate")));
            issueBookActivity.setBook(b);
            issueBookActivity.setMember(m);
            issueBookActivity.setDetails("Return");
            ...
            out.print("<html><body><p> An error occurred please try again <a href=\"viewAllBooks\">Back</a> </p></body></html>");
        }
        }else {
            PrintWriter out=resp.getWriter();
