...
<div class="container">
    <div class="jumbotron">
        <table class="table table-bordered">
            ...
            <c:forEach var="one" items="${oneBook}">
            <tr>

                <td><c:out value="${one.bookReg}"></c:out></td>
                <td><c:out value="${one.title}"></c:out></td>
                <td><c:out value="${one.auther}"></c:out></td>
                <td><c:out value="${one.publisher}"></c:out></td>
                <td><c:out value="${one.bookCategory}"></c:out></td>
                <td><c:out value="${one.status}"></c:out></td>
